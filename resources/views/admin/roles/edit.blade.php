                  ...
                  <div class="tab-content">
                    ...
                    <div class="active tab-pane" id="settings">
                      <form class="form-horizontal" method="POST" action="{{ route('admin.roles.update', $role) }}">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input type="text" value="{{ $role->name }}" class="form-control" id="name" name="name" placeholder="name">
                            @error('name')
                    ...
                    <h4><span class="badge bg-light ">Roles Permissions</span></h4>
                      ...
                      <div class="form-group"></div>
                        ...
                        <form
                        method="POST" 
                        action="{{ route('admin.roles.permissions.revoke', [$role, $role_permission->id]) }}"
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('admin.roles.permissions', $role) }}">
                      @csrf
                        <div class="form-group row">
                          <label for="name" class="col-sm-2 col-form-label">Permission Name</label>
                          <div class="col-sm-10">
