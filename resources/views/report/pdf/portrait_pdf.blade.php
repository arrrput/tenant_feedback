...
<body>
  ...
  <main>
    ...
    <table class="styled-table" >
      ...
      <tbody>
        <tr>
          ...
          <td class="border">{{ $pg->akar_penyebab }}</td>
          <td class="border">{{ $pg->message }}</td>
          <td class="border">{{  date('d M Y', strtotime($finish->created_at)) }}</td>
        </tr>
    ...
    <table class="styled-table">
      <tbody>
        <tr >
          <td style="text-align: center; max-height: 450px;"><img src="{{ public_path('storage/img_progress/'.$request->image) }}"/> </td>
          <td style="text-align: center; max-height: 450px;"><img src="{{ public_path('storage/img_finish/'.$finish->image) }}" /> </td>
        </tr>
        <tr>
          <td style="text-align: center;">Before </td>
          <td style="text-align: center;">After finish Task </td>
        </tr>
      </tbody>
    </table>
